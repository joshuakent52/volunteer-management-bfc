      ...
      <div style={{ maxWidth: '600px', margin: '0 auto' }}>
        ...
        {tab === 'clock' && (
          <div style={S.card}>
            ...
            {lunchAssignment && (
              <div style={{ marginTop: '1rem', padding: '0.75rem 1rem', background: 'rgba(251,146,60,0.07)', border: '1px solid rgba(251,146,60,0.35)', borderRadius: '8px' }}>
                ...
                <p style={{ fontWeight: 600, color: '#f97316', fontSize: '0.95rem' }}>
